...
<body>
	...
	<FORM class="form-horizontal" method="post" action="update_verify.jsp">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="inputName" name="userName"
								value=<%=userInfo[0]%> placeholder="Name" required>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="inputPassword" name="userPassword"
								value=<%=userInfo[1]%> placeholder="Password" required>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row-fluid">
				<div class="span4 offset 4">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="inputMajor" name="userMajor"
								value=<%=userInfo[3]%> placeholder="Major" required>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row-fluid">
				<div class="span4 offset 4">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="inputMajor" name="userEmail"
								value=<%=userInfo[2]%> placeholder="Email">
						</div>
					</div>
				</div>
			</div>
		...
		<input type="reset" class="btn" onclick="location.href='main.jsp'"
			value="cancel" /> <input type="submit" class="btn" value="update">
	</FORM>
