...
mySQL += "(SELECT c_id as id, c_id_no as id_no, COUNT(*) AS cnt  ";
mySQL += "from enroll   ";
mySQL += "group by c_id, c_id_no)    ";
mySQL += "where t.p_id='"+session_id+"' AND c.c_id=t.c_id AND c.c_id_no=t.c_id_no and c.c_id = id and c.c_id_no = id_no";
