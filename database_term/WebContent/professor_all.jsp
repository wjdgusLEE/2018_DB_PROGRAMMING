...
<body>
	<table width="75%" align="center" border>
		<tr>
			<th><div align="center">강의 번호</div></th>
			<th><div align="center">분반 번호</div></th>
			...
			<th><div align="center">교시</div></th>
			<th><div align="center">수강 제한</div></th>
		...
		<%
			...
			mySQL += "select c_id from teach where p_id = '" + session_id
					+ "') group by c.c_id, c.c_id_no), course cmp where cmp.c_id = id and cmp.c_id_no = no_id";
		...
		<tr>
			...
			<td><div align="center">
					<%=result.getInt("c_id_no")%>
				</div></td>
			<td><div align="center">
					<%=result.getString("c_name")%>
				</div></td>
			<td><div align="center">
					<%=result.getString("c_major")%>
				</div></td>
			<td><div align="center">
					<%=result.getInt("c_unit")%>
				</div></td>
			<td><div align="center">
					<%=result.getInt("c_grade")%>
				</div></td>
			<td><div align="center">
					<%=result.getInt("c_semester")%>
				</div></td>
			<td><div align="center">
					<%=result.getString("c_day")%>
				</div></td>
			<td><div align="center">
					<%=result.getInt("c_time")%>
				</div></td>
			<td><div align="center">
					<%=result.getInt("c_grade")%>
				</div></td>
