...
insert into course values('c002', 2, '데이터베이스', '컴퓨터과학과', 2, 3, 2,'화/목', 3, 25);
insert into course values('c003', 1, '프로그래밍언어론', '컴퓨터과학과', 3, 3, 1,'월/수', 5, 55);
insert into course values('c004', 1, '수치해석', '컴퓨터과학과', 3, 2, 1,'화/목', 2, 30);
insert into course values('c005', 1, '운영체제', '컴퓨터과학과', 3, 4, 2,'화/목', 2, 40);
...
insert into enroll values('1500004', 'c004');
insert into enroll values('1500004', 'c001');
insert into enroll values('1500000', 'c001');
insert into enroll values('1500000', 'c002');
insert into enroll values('1500001', 'c004');
insert into enroll values('1500001', 'c003');
insert into enroll values('1500002', 'c002');
insert into enroll values('1500002', 'c003');


CREATE TABLE teach
(
    p_id VARCHAR2(10) CONSTRAINT t_p_fk REFERENCES professor(p_id),
    c_id VARCHAR2(10) CONSTRAINT t_c_fk REFERENCES course(c_id),
    CONSTRAINT t_uk UNIQUE(p_id, c_id)
);

insert into teach values('p001', 'c001');
insert into teach values('p001', 'c002');
insert into teach values('p002', 'c003');
insert into teach values('p003', 'c004');
insert into teach values('p004', 'c005');
...
insert into manager values('m01', '1111','김철수', 'manager1@gmail.com');
insert into manager values('m02', '2222','당나철', 'manager2@yahoo.com');
